    ...
    return (
        <>
            ...
            <div className="py-2 text-center">
                <p>Here you can find Various Apps that are created with React-Vite</p>
                <p>Click the Logo to Navigate back to the HomePage</p>
                <p>Click the various links to navigate to the app that you like</p>
                <hr/>
            </div>
